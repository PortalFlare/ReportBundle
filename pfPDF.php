...
class pfPDF extends \TCPDF
{
    ...
    public function Header()
    {
        if ($this->print_header) {
            ...
            if (sizeof($this->columns) > 0) {
                ...
                $this->SetFillColor($this->columnheaderfillcolor['r'],
                                    $this->columnheaderfillcolor['g'],
                                    $this->columnheaderfillcolor['b']
                );
                // Get row height
                $rowheight = 0;
    ...
    public function MultiCell($w, $h, $txt, $border = 0, $align = 'J', $fill = false, $ln = 1,
                              $x = '', $y = '', $reseth = true, $stretch = 0, $ishtml = false,
